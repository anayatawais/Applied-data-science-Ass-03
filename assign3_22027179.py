...
popt, pcorr = opt.curve_fit(logistics, swed["date"], swed["cereal"], p0=(1e8, 0.04, 1985.0), maxfev=100)
print("Fit parameter", popt)
swed["pop_logistics"] = logistics(swed["date"], *popt)
plt.figure()
plt.title("logistics function")
plt.plot(swed["date"], swed["cereal"], label="data")
plt.plot(swed["date"], swed["pop_logistics"], label="fit")
plt.legend()
plt.show()
print("Cereal yield in")
...
popt, pcorr = opt.curve_fit(poly, swed["date"], swed["cereal"])
print("Fit parameter", popt)
...
swed["poly"] = poly(swed["date"], *popt)
plt.figure()
plt.title("polynomial")
plt.plot(swed["date"], swed["cereal"], label="data")
plt.plot(swed["date"], swed["poly"], label="fit")
